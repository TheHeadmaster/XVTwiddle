...
namespace XVTwiddle
{
    ...
    {
        /// <summary>
        /// Gets the directory for XVTwiddle that lies inside of the user's AppData directory.
        /// </summary>
        public string AppDataDirectory => Path.Combine(AppMeta.AppDataDirectory, "XVTwiddle");
        ...
        /// <summary>
        /// Gets or sets whether the program is running in debug mode or not.
        /// </summary>
        ...
        public async Task ChangeCurrentProject([DisallowNull] Project project) =>
